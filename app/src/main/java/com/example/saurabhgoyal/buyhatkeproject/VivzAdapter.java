...
public class VivzAdapter extends RecyclerView.Adapter<VivzAdapter.MyViewHolder> {
    ...
    ArrayList<Users> data= new ArrayList<>();//take care of null pointer exception
    private Context context;

    public VivzAdapter(Context context, ArrayList<Users> data){
...
Users current=data.get(i);
        Log.d("Vivz", "on bind view holder is called" + i);
        viewHolder.title.setText(current.getUsername());
    }
